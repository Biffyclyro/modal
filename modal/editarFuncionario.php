        ...
        <div class="col-md-12">
          ...
          <form class="" method="post" action="controleFuncionario.php">
            ...
            <div class="form-group"> 
              ...
              <input type="text" class="form-control" placeholder="Digite o nome do(a) funcionário(a)" name="nome" id="nome" value="<?php echo $nome; ?>"> </div>
            <div class="form-group"> 
              <label for="cargo">Cargo</label> 
              <input type="text" class="form-control" placeholder="Digite o cargo do(a) funcionário(a)" name="cargo" id="cargo" value="<?php echo $cargo; ?>"> 
            </div>
